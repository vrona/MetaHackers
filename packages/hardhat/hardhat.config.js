...
/* To Get realtime Gas Price from Mumbai Testnet
...
const MUMBAI_RPC_URL_IIROW = process.env.MUMBAI_RPC_URL_IIROW;
...
module.exports = {
  ...
  networks: {
    ...
    /*hardhat: {
      forking: {
        url: "https://polygon-mumbai.g.alchemy.com/v2/WQMLWc2uGOBy77Fx6_sSH2-fhED5v1Gt",
        blockNumber: 27589412
      }
    },
    ...
    */
    ...
    mumbai: {
      url: MUMBAI_RPC_URL_IIROW,
      //gas: 21000,
      gasPrice: 34314618447, //33178836060, gas * price + value
      accounts: {
        mnemonic: mnemonic(),
      },
    }
  ...
  */
  ...
  etherscan: {
    apiKey: POLYSCAN_API_KEY // ETHERSCAN_API_KEY //  
  },
};

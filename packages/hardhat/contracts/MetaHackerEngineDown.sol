...
Internal Engine for combinaison of traits (version of genes) dealing with less genes' variations.
*/
...
contract MetaHackerEngineDown is IMetaHackerDNA, AccessControl {
  ...
  */
  ...
  constructor(IMetaHackerMotherBase _metahackermotherbase) {
    ...
    // backgColor
    rarities[0] = [115, 221, 362, 413];
    aliases[0] = [3, 3, 3, 2];
    // bodyColor
    rarities[1] = [115, 221, 362, 413];
    ...
    aliases[3] = [4];
    // eyesbShape
    rarities[4] = [57, 92, 164, 218, 268, 312];
    aliases[4] = [11, 41, 13, 50, 11, 41];
    // mouthShape
    rarities[5] = [43, 58, 107, 153, 231, 238, 281];
    aliases[5] = [32, 33, 54, 31, 32, 60, 31];
    // hairShape
    rarities[6] = [115, 221, 362, 413];
    aliases[6] = [43, 12, 8, 12];
    // glassShape
    rarities[7] = [169, 366, 576];
    aliases[7] = [51, 10, 10];
    // clothShape
    rarities[8] = [70, 162, 221, 299, 359];

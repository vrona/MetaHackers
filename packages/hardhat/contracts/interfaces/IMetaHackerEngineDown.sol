...
interface IMetaHackerEngineDown is IMetaHackerDNA {
  ...
  function mhEngineering(Generation generation, uint256 _tokenId, uint256 seed) external returns (Genes memory rmht);
